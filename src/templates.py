...
class templates(object):
    ...
    def generate_metadata(self):
        ...
        article = None
        try:
            with open(os.path.join(TEMPLATE_DIR, 'articles.tmpl'), 'r') as article_file:
        ...
        metafile_str = self.get_template("feed.tmpl", posts=metadata)
        try:
            with open(os.path.join(TEMPLATE_DIR, 'feed.xml'), 'w') as xml_file:
                xml_file.write(metafile_str)
    ...
    def get_feed(self):
        '''
        Returns the feed generated by 'generate_metadata'
        '''
        return self.get_template('feed.xml')
